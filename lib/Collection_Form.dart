...
// class Collection_form extends StatefulWidget {
//   const Collection_form({Key? key, required this.collectorId})
//       : super(key: key);
...
//       // Fetch email ID from the selectedUserEmail variable
//       if (selectedUserEmail != null) {
//         print('Selected farmer email: $selectedUserEmail');
//         // Perform further operations with the email ID
//       }
...
//     final message = Message()
//       ..from = Address(username, 'MilkEasy')
//       ..recipients.add(selectedUserEmail ?? '')
//       ..subject = "Today's milk collection data"
//       ..text =
//           "Hello ${selectedUsername?.name}, your milk quantity of ${fatController.text} liters is collected by our collector. Thank you!";
...
//                 ),
//                 value: selectedUsername,
//                 onChanged: (Username? newValue) async {
//                   setState(() {
//                     selectedUsername = newValue;
//                   });

//                   final response = await http.get(Uri.parse(
//                       'http://192.168.1.7:2000/user/FarmerEmail${newValue}'));
//                   if (response.statusCode == 200) {
//                     final body = jsonDecode(response.body);
